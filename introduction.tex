...
\item Four use cases detailing LLNL's use of Spack to compose
      software configurations rapidly, to manage Python installations,
      to implement site build policies, and to build an LLNL production
      code with 47 dependencies in 32 configurations.
\end{enumerate}

\noindent Spack is in active development at LLNL, and our use cases
outline some of its first applications in our environment.  
