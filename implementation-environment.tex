...
\begin{figure}
	...
	\caption{
		Build times with and without Spack's compiler wrappers.
		\label{fig:wrapper-overhead}
	}
\end{figure}

Spack's compiler wrappers incur a small amount of overhead because they intercept
calls to compilers within a build.  Figure~\ref{fig:wrapper-overhead} shows build time
