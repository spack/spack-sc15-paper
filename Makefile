...
# LaTeX diff command
latexdiff = latexdiff-vc --git -c review-process/latexdiff.cfg -r shepherd.1
...
# Diff all the files
	...
	for file in $$files; do \
		diff_file=`echo $$file | sed 's/.tex$$/-diffshepherd.1.tex/'` && mv $$diff_file $$file; \
	done
