...
Others, such as Anaconda~\cite{anaconda,conda}, use the same approach but
are designed to run on top of a host OS.
...
of compiler, MPI version, build options, and dependency versions requires 
tedious modifications of many package files. Indeed, the number of package 
